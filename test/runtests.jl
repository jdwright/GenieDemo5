...
# !!! Main.UserApp is configured as an alias for Main.GenieDemo5 and you might encounter it in some tests
using Main.GenieDemo5, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "GenieDemo5 tests" begin
  @includetests ARGS
end
